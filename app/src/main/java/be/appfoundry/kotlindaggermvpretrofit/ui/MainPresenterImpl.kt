...
import be.appfoundry.kotlindaggermvpretrofit.core.mvp.BaseRxPresenter
...
class MainPresenterImpl @Inject constructor(githubAPI: GithubAPI) : BaseRxPresenter<MainView>(), MainPresenter {
